...
impl From<NativeMouseButton> for fyrox_lite::lite_input::LiteMouseButton {
...
impl From<fyrox_lite::lite_input::LiteMouseButton> for NativeMouseButton {
    fn from(__value: fyrox_lite::lite_input::LiteMouseButton) -> Self {
        if let fyrox_lite::lite_input::LiteMouseButton::Left = __value {
            return NativeMouseButton {
                tag: NativeMouseButton::Left,
            };
        }
        if let fyrox_lite::lite_input::LiteMouseButton::Right = __value {
            return NativeMouseButton {
                tag: NativeMouseButton::Right,
            };
        }
        if let fyrox_lite::lite_input::LiteMouseButton::Middle = __value {
            return NativeMouseButton {
                tag: NativeMouseButton::Middle,
            };
        }
        if let fyrox_lite::lite_input::LiteMouseButton::Back = __value {
            return NativeMouseButton {
                tag: NativeMouseButton::Back,
            };
        }
        if let fyrox_lite::lite_input::LiteMouseButton::Forward = __value {
            return NativeMouseButton {
