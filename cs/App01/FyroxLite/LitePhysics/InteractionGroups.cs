...
internal partial struct InteractionGroups_slice
{
    ...
    private static unsafe partial InteractionGroups_slice fyrox_lite_upload_fyrox_lite_lite_physics_LiteInteractionGroups_slice(InteractionGroups_slice managed);
}
