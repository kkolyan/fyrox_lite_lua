    ...
    fn add_instance_methods<'lua, M: mlua::UserDataMethods<'lua, Traitor<Self>>>(methods: &mut M) {
        ...
        methods.add_method_mut("as_rigid_body", |lua, this, (): ()| {
            ...
            let ret = if let Some(ret) = ret {
                Some(Traitor::new(lite_physics::LiteRigidBody::from(ret)))
            } else {
                None
            };
            Ok(ret)
        ...
        methods.add_method_mut("global_position", |lua, this, (): ()| {
            ...
            let ret = Traitor::new(fyrox_lite_math::LiteVector3::from(ret));
            Ok(ret)
        });
        ...
        methods.add_method_mut("local_rotation", |lua, this, (): ()| {
            ...
            let ret = Traitor::new(fyrox_lite_math::LiteQuaternion::from(ret));
            Ok(ret)
        });
        ...
        methods.add_method_mut(
            "set_local_position",
            |lua, this, (new_pos): (TypedUserData<Traitor<fyrox_lite_math::LiteVector3>>)| {
        ...
        methods.add_method_mut(
            "set_local_rotation",
            |lua, this, (value): (TypedUserData<Traitor<fyrox_lite_math::LiteQuaternion>>)| {
        ...
        methods.add_method_mut("try_get_collider", |lua, this, (): ()| {
            ...
            let ret = if let Some(ret) = ret {
                Some(Traitor::new(lite_node::LiteNode::from(ret)))
            } else {
                None
            };
            Ok(ret)
        ...
        methods.add_method_mut("set_tag", |lua, this, (tag): (mlua::String)| {
            let tag = tag.to_str()?.to_string();
